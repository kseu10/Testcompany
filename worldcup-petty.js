const pettyCandidates = [
  ...
  { id: 3, title: "휴지 끝 지점 못 찾음 🧻", desc: "휴지나 테이프 쓰려고 하는데 끝 지점을 못 찾아서 헤맬 때", icon: "🧻", img: "wc_petty_bus.jpg", badge: "🤯 테이프 끝 탐색", votes: 4120 },
  ...
  { id: 7, title: "엘리베이터 닫힘 🛗", desc: "엘리베이터 층 버튼 누르고 들어가려는 순간 닫힘 버튼 누르고 홀랑 올라갈 때", icon: "🛗", img: "wc_petty_bus.jpg", badge: "🛗 닫힘 얌체", votes: 4890 },
  ...
  { id: 9, title: "새끼손가락 문틀 강타 🦶", desc: "집에서 걸어가다가 침대 다리나 문틀에 새끼발가락 강하게 찍힐 때", icon: "🦶", img: "wc_petty_socks.jpg", badge: "⚡ 새끼발가락 파괴", votes: 6450 },
  { id: 10, title: "과자 봉지 찢어짐 🍪", desc: "과자 예쁘게 뜯으려다 비닐 봉지 옆으로 쫙 찢어져서 다 쏟아질 때", icon: "🍪", img: "wc_petty_soup.jpg", badge: "🍪 봉지 찢어짐 쏟아질 때", votes: 3780 },
  { id: 11, title: "영화 클라이맥스 카톡 알림 📱", desc: "영화 하이라이트 씬에 휴대폰 징 진동 계속 울릴 때", icon: "📱", img: "wc_movie_phone.jpg", badge: "🎬 하이라이트 진동", votes: 2980 },
  { id: 12, title: "샤워 중 찬물 세례 🚿", desc: "샤워 잘하고 있는데 갑자기 얼음 같은 찬물 세례 쏟아질 때", icon: "🚿", img: "wc_petty_socks.jpg", badge: "🧊 샤워 찬물 폭탄", votes: 4670 },
  { id: 13, title: "배달 음식 젓가락 누락 🥢", desc: "배달 음식 도착해서 뜯었는데 젓가락/숟가락 안 들어있을 때", icon: "🥢", img: "wc_movie_takoyaki.jpg", badge: "🍱 수저 누락 멘붕", votes: 4190 },
  { id: 14, title: "손톱 옆 살점 뜯김 💅", desc: "손톱 옆에 조그만 가시 살점 뜯으려다 피나고 얼얼할 때", icon: "💅", img: "wc_petty_socks.jpg", badge: "😭 살점 뜯김 고통", votes: 3540 },
  { id: 15, title: "우산 가져온 날 해 쨍쨍 ☂️", desc: "일기예보 보고 긴 우산 챙겨서 나왔는데 하루 종일 햇빛 쨍쨍할 때", icon: "☂️", img: "wc_petty_bus.jpg", badge: "☀️ 우산 짐 덩어리", votes: 2890 },
  { id: 16, title: "키보드 틈새 과자 가루 ⌨️", desc: "노트북 키보드 사이로 과자 부스러기 들어가서 안 빼질 때", icon: "⌨️", img: "wc_petty_soup.jpg", badge: "⌨️ 키보드 과자 가루", votes: 3120 }
];
