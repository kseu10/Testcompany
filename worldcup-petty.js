const pettyCandidates = [
  ...
  { id: 3, title: "휴지 끝 지점 못 찾음 🧻", desc: "휴지나 테이프 쓰려고 하는데 끝 지점을 못 찾아서 헤맬 때", icon: "🧻", img: "petty_3_tape.jpg", badge: "🤯 테이프 끝 탐색", votes: 4120 },
  { id: 4, title: "국물 옷에 튐 🍜", desc: "흰 옷 입은 날 빨간 짬뽕 국물 딱 한 방울 가슴 한가운데 튈 때", icon: "🍜", img: "wc_petty_soup.jpg", badge: "👔 흰 옷 국물 테러", votes: 6150 },
  { id: 5, title: "블루투스 이어폰 방전 🎧", desc: "지하철 탔는데 블루투스 이어폰 배터리 1% 나오면서 꺼질 때", icon: "🎧", img: "petty_5_earphone.jpg", badge: "🪫 지하철 이어폰 방전", votes: 5410 },
  { id: 6, title: "음식 사진 찍기 전 젓가락 🥢", desc: "인스타 사진 찍으려고 세팅해놨는데 친구가 젓가락 먼저 댈 때", icon: "🥢", img: "petty_6_chopstick.jpg", badge: "📸 플레이팅 붕괴", votes: 3290 },
  { id: 7, title: "엘리베이터 닫힘 🛗", desc: "엘리베이터 층 버튼 누르고 들어가려는 순간 닫힘 버튼 누르고 홀랑 올라갈 때", icon: "🛗", img: "petty_7_elevator.jpg", badge: "🛗 닫힘 얌체", votes: 4890 },
  { id: 8, title: "자동 완성 오타 전송 💬", desc: "부장님한테 카톡 보내는데 자동 완성으로 웃긴 오타 그대로 보내졌을 때", icon: "💬", img: "petty_8_typo.jpg", badge: "📲 대참사 오타 전송", votes: 5120 },
  { id: 9, title: "새끼손가락 문틀 강타 🦶", desc: "집에서 걸어가다가 침대 다리나 문틀에 새끼발가락 강하게 찍힐 때", icon: "🦶", img: "petty_9_toe.jpg", badge: "⚡ 새끼발가락 파괴", votes: 6450 },
  { id: 10, title: "과자 봉지 찢어짐 🍪", desc: "과자 예쁘게 뜯으려다 비닐 봉지 옆으로 쫙 찢어져서 다 쏟아질 때", icon: "🍪", img: "petty_10_chips.jpg", badge: "🍪 봉지 찢어짐 쏟아질 때", votes: 3780 },
  { id: 11, title: "영화 클라이맥스 카톡 알림 📱", desc: "영화 하이라이트 씬에 휴대폰 징 진동 계속 울릴 때", icon: "📱", img: "petty_11_vibration.jpg", badge: "🎬 하이라이트 진동", votes: 2980 },
  { id: 12, title: "샤워 중 찬물 세례 🚿", desc: "샤워 잘하고 있는데 갑자기 얼음 같은 찬물 세례 쏟아질 때", icon: "🚿", img: "petty_12_cold_shower.jpg", badge: "🧊 샤워 찬물 폭탄", votes: 4670 },
  { id: 13, title: "배달 음식 젓가락 누락 🥢", desc: "배달 음식 도착해서 뜯었는데 젓가락/숟가락 안 들어있을 때", icon: "🥢", img: "petty_13_no_chopstick.jpg", badge: "🍱 수저 누락 멘붕", votes: 4190 },
  { id: 14, title: "손톱 옆 살점 뜯김 💅", desc: "손톱 옆에 조그만 가시 살점 뜯으려다 피나고 얼얼할 때", icon: "💅", img: "petty_14_skin.jpg", badge: "😭 살점 뜯김 고통", votes: 3540 },
  { id: 15, title: "우산 가져온 날 해 쨍쨍 ☂️", desc: "일기예보 보고 긴 우산 챙겨서 나왔는데 하루 종일 햇빛 쨍쨍할 때", icon: "☂️", img: "petty_15_sunny_umbrella.jpg", badge: "☀️ 우산 짐 덩어리", votes: 2890 },
  { id: 16, title: "키보드 틈새 과자 가루 ⌨️", desc: "노트북 키보드 사이로 과자 부스러기 들어가서 안 빼질 때", icon: "⌨️", img: "petty_16_crumbs.jpg", badge: "⌨️ 키보드 과자 가루", votes: 3120 }
];
