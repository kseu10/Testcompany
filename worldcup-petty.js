const pettyCandidates = [
  ...
  { id: 2, title: "눈앞에서 버스 출발 🚌", desc: "신호등 건너서 버스 정류장 도착하자마자 버스 출발할 때", icon: "🚌", img: "wc_travel_stingy.jpg", badge: "🏃‍♂️ 눈앞 버스 놓침", votes: 5920 },
  { id: 3, title: "휴지 끝 지점 못 찾음 🧻", desc: "휴지나 테이프 쓰려고 하는데 끝 지점을 못 찾아서 헤맬 때", icon: "🧻", img: "work_3.jpg", badge: "🤯 테이프 끝 탐색", votes: 4120 },
  { id: 4, title: "국물 옷에 튐 🍜", desc: "흰 옷 입은 날 빨간 짬뽕 국물 딱 한 방울 가슴 한가운데 튈 때", icon: "🍜", img: "wc_movie_takoyaki.jpg", badge: "👔 흰 옷 국물 테러", votes: 6150 },
  { id: 5, title: "블루투스 이어폰 방전 🎧", desc: "지하철 탔는데 블루투스 이어폰 배터리 1% 나오면서 꺼질 때", icon: "🎧", img: "wc_movie_phone.jpg", badge: "🪫 지하철 이어폰 방전", votes: 5410 },
  { id: 6, title: "음식 사진 찍기 전 젓가락 🥢", desc: "인스타 사진 찍으려고 세팅해놨는데 친구가 젓가락 먼저 댈 때", icon: "🥢", img: "face_style_1.jpg", badge: "📸 플레이팅 붕괴", votes: 3290 },
  { id: 7, title: "엘리베이터 닫힘 🛗", desc: "엘리베이터 층 버튼 누르고 들어가려는 순간 닫힘 버튼 누르고 홀랑 올라갈 때", icon: "🛗", img: "work_1.jpg", badge: "🛗 닫힘 얌체", votes: 4890 },
  ...
  { id: 12, title: "샤워 중 찬물 세례 🚿", desc: "샤워 잘하고 있는데 갑자기 얼음 같은 찬물 세례 쏟아질 때", icon: "🚿", img: "mental_2.jpg", badge: "🧊 샤워 찬물 폭탄", votes: 4670 },
  ...
  { id: 15, title: "우산 가져온 날 해 쨍쨍 ☂️", desc: "일기예보 보고 긴 우산 챙겨서 나왔는데 하루 종일 햇빛 쨍쨍할 때", icon: "☂️", img: "spending_2.jpg", badge: "☀️ 우산 짐 덩어리", votes: 2890 },
