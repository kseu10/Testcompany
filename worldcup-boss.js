const bossCandidates = [
  ...
  { id: 5, title: "답정너 무한 수정 ✏️", desc: "기획서 10번 고치게 만들고 결국 맨 처음 제출안 선택하는 답정너", icon: "✏️", img: "work_3.jpg", badge: "🔄 무한 노가다 수정", votes: 5320 },
  { id: 6, title: "라떼는 말이야 ☕", desc: "자기 젊을 땐 야근 주 7일 했다며 요즘 애들 태도 따지는 꼰대", icon: "☕", img: "wc_boss_latte.jpg", badge: "☕ 라떼 꼰대 훈수", votes: 4950 },
  { id: 7, title: "책임 회피 마스터 🏃", desc: "문제 생기면 '부하 직원이 보고 안 했다'며 뒤집어씌우는 상사", icon: "🏃", img: "work_2.jpg", badge: "🎯 부하 핑계 뒤집어씌우기", votes: 5110 },
  ...
  { id: 12, title: "마이크로 매니징 감시 🔍", desc: "10분마다 책상 와서 메신저 화면 화면 훔쳐보는 사르만", icon: "🔍", img: "work_1.jpg", badge: "🖥️ 모니터 등뒤 감시", votes: 4210 },
  { id: 13, title: "반말 지거리 무례러 🗣️", desc: "처음 본 부하 직원한테 대놓고 반말하고 팩폭이랍시고 외모 지적하는 사람", icon: "🗣️", img: "wc_movie_spoiler.jpg", badge: "🤐 무례한 반말 폭격", votes: 3980 },
  { id: 14, title: "업무 시도 때도 없이 체인지 🌪️", desc: "오전에 방향 A라 해놓고 오후에 '내가 언제?' 하며 B로 바꾸는 붕어", icon: "🌪️", img: "wc_travel_planner.jpg", badge: "❓ 아침저녁 딴소리", votes: 4340 },
  { id: 15, title: "자랑질 자랑 몬스터 👑", desc: "업무 미팅 때 자기 자랑, 자기 집안 자랑만 30분 동안 하는 몬스터", icon: "👑", img: "spending_1.jpg", badge: "😴 30분 자기자랑", votes: 2540 },
  { id: 16, title: "메일 CC 테러범 📧", desc: "사소한 실수 하나에 전 부서장, 이사님 CC 넣어서 공개 처형하는 빌런", icon: "📧", img: "mental_1.jpg", badge: "📢 전사 공개 처형 CC", votes: 5670 }
];
