const movieCandidates = [
  { id: 1, title: "스포일러 입털기 🗣️", desc: "영화 내내 '어 저 사람 죽나?' 스포일러 입털기 마스터", icon: "🗣️", img: "wc_movie_spoiler.jpg", badge: "🚨 스포일러 입털기", votes: 6120 },
  { id: 2, title: "팝콘 오도독 쩝쩝이 🍿", desc: "팝콘 오도독 소리 내며 콜라 얼음 달그락거리는 쩝쩝이", icon: "🍿", img: "wc_movie_popcorn.jpg", badge: "🔊 쩝쩝 소음 테러", votes: 4580 },
  { id: 3, title: "스마트폰 10분 레이저 📱", desc: "10분마다 휴대폰 켜서 밝은 화면으로 카톡 확인하는 민폐", icon: "📱", img: "wc_movie_phone.jpg", badge: "💡 눈뽕 비매너", votes: 5210 },
  { id: 4, title: "영화 중 계속 귓속말 🙋", desc: "영화 중간에 이해 안 된다고 계속 옆에서 '저 사람 누구야?' 질문", icon: "🙋", img: "wc_movie_whisper.jpg", badge: "❓ 귓속말 질의응답", votes: 3890 },
  { id: 5, title: "오열 과몰입러 😭", desc: "슬픈 장면도 아닌데 옆에서 꺼이꺼이 통곡하며 오열하는 과몰입러", icon: "😭", img: "wc_movie_cry.jpg", badge: "😭 과몰입 오열", votes: 2340 },
  { id: 6, title: "평론가 행세 분위기 초치기 🎬", desc: "영화 끝난 후 '솔직히 기대 이하네' 평론가 행세하며 분위기 초 치는 타입", icon: "🎬", img: "wc_movie_critic.jpg", badge: "👎 분위기 초치기", votes: 3120 },
  { id: 7, title: "15분 드렁드렁 코골이 💤", desc: "영화 시작하자마자 15분 만에 드렁드렁 코 골며 자는 사람", icon: "💤", img: "wc_movie_snore.jpg", badge: "💤 극장 코골이", votes: 3450 },
  { id: 8, title: "화장실 지연러 🚪", desc: "러닝타임 내내 시도 때도 없이 화장실 왔다 갔다 자리를 가리는 사람", icon: "🚪", img: "wc_movie_toilet.jpg", badge: "🏃‍♂️ 수시로 자릿길 막기", votes: 2980 },
  { id: 9, title: "의자 툭툭이 🦶", desc: "앞자리 의자 발로 수시로 차는 툭툭이", icon: "🦶", img: "wc_movie_kick.jpg", badge: "🦶 등받이 킥 테러", votes: 4890 },
  { id: 10, title: "20분 지각 헐떡이 🏃", desc: "자기가 예매해놓고 늦어서 영화 시작 20분 후에 헐떡이며 들어오는 사람", icon: "🏃", img: "wc_petty_bus.jpg", badge: "⏰ 지각 헐떡 민폐", votes: 2650 },
  { id: 11, title: "사설 추임새 중얼이 💬", desc: "영화 도중에 귓속말로 계속 자기 생각 사설 붙이는 중얼이", icon: "💬", img: "wc_movie_whisper.jpg", badge: "💬 나홀로 음성 해설", votes: 2780 },
  { id: 12, title: "쩍벌 자리 침범러 🧘", desc: "옆사람 좌석 영역까지 몸 기울이고 다리 쩍벌하는 쩍벌남녀", icon: "🧘", img: "wc_movie_manspread.jpg", badge: "💥 무단 영역 침범", votes: 3670 },
  { id: 13, title: "공포 비명 데시벨 😱", desc: "공포 영화 볼 때 비명 질러서 영화보다 더 놀라게 하는 관객", icon: "😱", img: "wc_movie_cry.jpg", badge: "📢 초고주파 비명", votes: 2450 },
  { id: 14, title: "엔딩 바로 벌떡이 🚶", desc: "영화 끝나자마자 엔딩 크레딧 올라가기도 전에 불쑥 일어나 가로막는 사람", icon: "🚶", img: "wc_movie_critic.jpg", badge: "🚶 시야 불쑥 차단", votes: 1980 },
  { id: 15, title: "타코야끼 냄새 빌런 🐙", desc: "영화관에 냄새 강한 타코야끼/오징어 사들고 와서 냄새 풍기는 타입", icon: "🐙", img: "wc_movie_takoyaki.jpg", badge: "🚨 극장 냄새 테러", votes: 3150 },
  { id: 16, title: "지루함 불평 러버 🥱", desc: "자기가 보자고 해놓고 정작 본인은 재미없다고 지루해하는 타입", icon: "🥱", img: "wc_movie_phone.jpg", badge: "🥱 자기가 보자해놓고 불평", votes: 3560 }
];
