const travelCandidates = [
  ...
  { id: 2, title: "숙소 굼뱅이 🏨", desc: "무조건 숙소에서 뒹굴거리며 배달 음식만 먹자는 굼뱅이", icon: "🏨", img: "mental_2.jpg", badge: "🛌 숙소 콕 집돌이", votes: 3890 },
  { id: 3, title: "분 단위 교관 ⏱️", desc: "분 단위로 일정 짜놓고 안 지키면 표정 차가워지는 교관", icon: "⏱️", img: "work_1.jpg", badge: "⚔️ 일정 교관", votes: 4910 },
  { id: 4, title: "무소유 핑거 공주 👑", desc: "계획은 1도 안 짜면서 막상 오면 '여긴 별로다' 불평만 하는 핑공", icon: "👑", img: "love_enfp_doodle_1785654168966.jpg", badge: "👑 무임승차 핑공", votes: 6120 },
  { id: 5, title: "프로 투덜이 🗣️", desc: "덥다, 춥다, 다리 아프다 내내 입 툭 튀어나와 투덜거리는 사람", icon: "🗣️", img: "mental_2.jpg", badge: "😫 입툭튀 투덜이", votes: 4150 },
  { id: 6, title: "인스타 지옥 파파라치 📸", desc: "인생샷 건질 때까지 1,000장 찍게 시키고 안 마음에 들면 재촬영 시키는 사람", icon: "📸", img: "face_style_1.jpg", badge: "📸 1000장 지옥", votes: 5780 },
  ...
  { id: 9, title: "쇼핑봇 짐꾼러 🛍️", desc: "관광은 안 하고 기념품샵만 전전하며 내 가방에 짐 쑤셔 넣는 사람", icon: "🛍️", img: "spending_1.jpg", badge: "🛍️ 짐 쑤셔넣기", votes: 2890 },
  { id: 10, title: "숙취 시체 🍻", desc: "첫날밤 술 너무 마셔서 다음날 오후 3시까지 누워만 있는 시체", icon: "🍻", img: "mental_2.jpg", badge: "🤮 숙취 시체", votes: 4320 },
  { id: 11, title: "택시 전용 징징이 🚕", desc: "걸어서 5분 거리고 무조건 택시 타자고 징징대는 징징이", icon: "🚕", img: "wc_travel_stingy.jpg", badge: "🚕 5분 거리 택시파", votes: 2650 },
  { id: 12, title: "현지인 과몰입러 🗣️", desc: "영어도 못 하면서 현지인한테 콩글리시로 계속 말 걸어서 곤란하게 하는 사람", icon: "🗣️", img: "face_style_1.jpg", badge: "😅 콩글리시 폭주", votes: 2180 },
  { id: 13, title: "지갑 분실 소동꾼 👛", desc: "여권, 지갑, 핸드폰 하루에 3번씩 잃어버렸다고 난리 치는 사람", icon: "👛", img: "wc_petty_socks.jpg", badge: "😱 분실 난리법석", votes: 3740 },
  { id: 14, title: "단독 행동 마이웨이 🚶", desc: "말도 없이 혼자 사라졌다가 저녁 먹을 때 슥 나타나는 마이웨이", icon: "🚶", img: "love_intj_doodle_1785654202978.jpg", badge: "🚶‍♂️ 무단 이탈자", votes: 3210 },
  { id: 15, title: "정산 미루기 마스터 💳", desc: "엔빵 정산하자고 하면 '나중에 한꺼번에 줄게' 하고 까먹는 얌체", icon: "💳", img: "wc_travel_stingy.jpg", badge: "🙈 정산 미루기", votes: 4980 },
  { id: 16, title: "체력 방전 징징이 🔋", desc: "일정 시작 30분 만에 다리 아프다며 카페 가서 앉아만 있자는 징징이", icon: "🔋", img: "mental_2.jpg", badge: "🪫 30분 방전러", votes: 3410 }
];
