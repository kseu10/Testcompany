const travelCandidates = [
  ...
  { id: 4, title: "무소유 핑거 공주 👑", desc: "계획은 1도 안 짜면서 막상 오면 '여긴 별로다' 불평만 하는 핑공", icon: "👑", img: "wc_travel_princess.jpg", badge: "👑 무임승차 핑공", votes: 6120 },
  { id: 5, title: "프로 투덜이 🗣️", desc: "덥다, 춥다, 다리 아프다 내내 입 툭 튀어나와 투덜거리는 사람", icon: "🗣️", img: "wc_travel_grumpy.jpg", badge: "😫 입툭튀 투덜이", votes: 4150 },
  ...
  { id: 7, title: "식성 빌런 🌶️", desc: "해외 와놓고 한식 아니면 입도 대지 않는 극단적 식성 빌런", icon: "🌶️", img: "wc_travel_food.jpg", badge: "🍚 무조건 한식파", votes: 3120 },
  ...
  { id: 10, title: "숙취 시체 🍻", desc: "첫날밤 술 너무 마셔서 다음날 오후 3시까지 누워만 있는 시체", icon: "🍻", img: "wc_travel_hangover.jpg", badge: "🤮 숙취 시체", votes: 4320 },
  { id: 11, title: "택시 전용 징징이 🚕", desc: "걸어서 5분 거리고 무조건 택시 타자고 징징대는 징징이", icon: "🚕", img: "wc_boss_errand.jpg", badge: "🚕 5분 거리 택시파", votes: 2650 },
  { id: 12, title: "현지인 과몰입러 🗣️", desc: "영어도 못 하면서 현지인한테 콩글리시로 계속 말 걸어서 곤란하게 하는 사람", icon: "🗣️", img: "wc_movie_whisper.jpg", badge: "😅 콩글리시 폭주", votes: 2180 },
  { id: 13, title: "지갑 분실 소동꾼 👛", desc: "여권, 지갑, 핸드폰 하루에 3번씩 잃어버렸다고 난리 치는 사람", icon: "👛", img: "wc_boss_meerkat.jpg", badge: "😱 분실 난리법석", votes: 3740 },
  { id: 14, title: "단독 행동 마이웨이 🚶", desc: "말도 없이 혼자 사라졌다가 저녁 먹을 때 슥 나타나는 마이웨이", icon: "🚶", img: "wc_boss_latte.jpg", badge: "🚶‍♂️ 무단 이탈자", votes: 3210 },
  { id: 15, title: "정산 미루기 마스터 💳", desc: "엔빵 정산하자고 하면 '나중에 한꺼번에 줄게' 하고 까먹는 얌체", icon: "💳", img: "wc_boss_steal.jpg", badge: "🙈 정산 미루기", votes: 4980 },
  { id: 16, title: "체력 방전 징징이 🔋", desc: "일정 시작 30분 만에 다리 아프다며 카페 가서 앉아만 있자는 징징이", icon: "🔋", img: "wc_movie_snore.jpg", badge: "🪫 30분 방전러", votes: 3410 }
];
